...
const typeColors: Record<string, string> = {
  "статус изменён": "bg-blue-500/15 text-blue-400",
  "новый вопрос": "bg-violet-500/15 text-violet-400",
  "передан эксперту": "bg-purple-500/15 text-purple-400",
  "получен ответ": "bg-emerald-500/15 text-emerald-400",
  "на уточнение": "bg-amber-500/15 text-amber-400",
  "упоминание": "bg-amber-500/15 text-amber-400",
  "блокер добавлен": "bg-red-500/15 text-red-400",
  "вопрос: сообщение": "bg-cyan-500/15 text-cyan-400",
  "вопрос: статус": "bg-indigo-500/15 text-indigo-400",
  "Вопрос долго без движения": "bg-orange-500/15 text-orange-400",
  "напоминание": "bg-rose-500/15 text-rose-300",
  "Kanban: новая задача": "bg-emerald-500/15 text-emerald-400",
};
