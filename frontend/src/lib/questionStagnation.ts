...
export function stagnationBadgeColorClass(hours: number): string {
  ...
  if (hours > 48) return "bg-red-500/15 text-red-700 dark:text-red-400 border-red-500/30";
  if (hours > 24) return "bg-amber-500/15 text-amber-700 dark:text-amber-400 border-amber-500/30";
